...
var win = Highcharts.win,
	...
	extend(defaultOptions.lang, {
		...
		downloadPNG: 'Загрузить график как PNG изображение',
		downloadJPEG: 'Загрузить график как JPEG изображение',
		downloadPDF: 'Загрузить график как PDF документ',
		downloadSVG: 'Загрузить SVG векторный файл',
		contextButtonTitle: 'Экспорт данных и печать'
	});
